...
**Important**  Use appropriate access modes for your data:
 ...
 - **Input/Ouput Buffers:** Use `sycl::access::mode::read_write` for the variables that are input, but they also get modified during the compuations.
...
``` 
or by using the `.get_access` memebr function of the buffer
```
